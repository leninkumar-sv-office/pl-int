...
export default function StandingInstructionTable({ instructions, loading, siDashboard, onAddSI, onEditSI, onDeleteSI }) {
  ...
  const [summaryCollapsed, setSummaryCollapsed] = useState(() => {
    try { return localStorage.getItem('siSummaryCollapsed') !== 'false'; } catch { return true; }
  });
  const toggleSummary = () => setSummaryCollapsed(prev => { const next = !prev; localStorage.setItem('siSummaryCollapsed', String(next)); return next; });
